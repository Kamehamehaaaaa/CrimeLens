...
if __name__ == "__main__":
    ...
    dm = DataManager("/Users/rohitbogulla/Desktop/Sem 3/Applied ML 2/CrimeLens/data/advanced_crime_data_2.csv")
    df = dm.getData()
    ...
    # Visualize any scene
    scene_df = df[df['scene_id'] == 254]

    # Option 1: Simple hypothesis
    results['hypothesis_generator'].visualize(scene_df)

    # Option 2: Full graph visualization
    results['graph_visualizer'].visualize_scene(scene_df)

    # Option 3: Explanation with feature importance
    results['explainer'].explain(scene_df)